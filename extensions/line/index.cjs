...
// src/core/extensions/line/index.ts
var index_exports = {};
__export(index_exports, {
  default: () => index_default
});
module.exports = __toCommonJS(index_exports);
var import_line3 = require("src/core/source/plugin-sdk/line");

// src/core/extensions/line/src/card-command.ts
var import_line = require("src/core/source/plugin-sdk/line");
      ...
      try {
        switch (type) {
          case "info": {
            ...
            const bubble = (0, import_line.createInfoCard)(title, body, footer);
          ...
          case "image": {
            ...
            const bubble = (0, import_line.createImageCard)(imageUrl, title, caption);
            return buildLineReply({
              flexMessage: {
          ...
          case "action": {
            ...
            const bubble = (0, import_line.createActionCard)(title, body, actions, {
          ...
          case "list": {
            ...
            const bubble = (0, import_line.createListCard)(title, items);
            return buildLineReply({
              flexMessage: {
          ...
          case "receipt": {
            ...
            const bubble = (0, import_line.createReceiptCard)({ title, items, total, footer });
            return buildLineReply({
              flexMessage: {
...
// src/core/extensions/line/src/channel.ts
var import_compat2 = require("src/core/source/plugin-sdk/compat");
var import_line2 = require("src/core/source/plugin-sdk/line");

// src/core/extensions/line/src/runtime.ts
var import_compat = require("src/core/source/plugin-sdk/compat");
var { setRuntime: setLineRuntime, getRuntime: getLineRuntime } = (0, import_compat.createPluginRuntimeStore)("LINE runtime not initialized - plugin not registered");
...
var lineConfigAccessors = (0, import_compat2.createScopedAccountConfigAccessors)({
...
var lineConfigBase = (0, import_compat2.createScopedChannelConfigBase)({
  sectionKey: "line",
...
var resolveLineDmPolicy = (0, import_compat2.createScopedDmSecurityResolver)({
  channelKey: "line",
  resolvePolicy: (account) => account.config.dmPolicy,
  resolveAllowFrom: (account) => account.config.allowFrom,
  policyPathSuffix: "dmPolicy",
  approveHint: "must-b pairing approve line <code>",
  normalizeEntry: (raw) => raw.replace(/^line:(?:user:)?/i, "")
});
function patchLineAccountConfig(cfg, lineConfig, accountId, patch) {
  if (accountId === import_line2.DEFAULT_ACCOUNT_ID) {
    return {
      ...cfg,
      channels: {
        ...cfg.channels,
...
var linePlugin = {
  ...
  pairing: {
    ...
    notifyApproval: async ({ cfg, id }) => {
      ...
      await line.pushMessageLine(id, "Must-b: your access has been approved.", {
  ...
  configSchema: (0, import_line2.buildChannelConfigSchema)(import_line2.LineConfigSchema),
  config: {
    ...lineConfigBase,
  ...
  setup: {
    ...
    validateInput: ({ accountId, input }) => {
      ...
      if (typedInput.useEnv && accountId !== import_line2.DEFAULT_ACCOUNT_ID) {
  ...
  outbound: {
    ...
    sendPayload: async ({ to, payload, accountId, cfg }) => {
      ...
      const processed = payload.text ? (0, import_line2.processLineMessage)(payload.text) : { text: "", flexMessages: [] };
    ...
    sendText: async ({ cfg, to, text, accountId }) => {
      ...
      const sendText = runtime.channel.line.pushMessageLine;
      const sendFlex = runtime.channel.line.pushFlexMessage;
      const processed = (0, import_line2.processLineMessage)(text);
      let result;
  ...
  status: {
    defaultRuntime: {
      accountId: import_line2.DEFAULT_ACCOUNT_ID,
      running: false,
      lastStartAt: null,
      lastStopAt: null,
      lastError: null
    ...
    collectStatusIssues: (accounts) => {
      ...
      for (const account of accounts) {
        const accountId = account.accountId ?? import_line2.DEFAULT_ACCOUNT_ID;
    ...
    buildChannelSummary: ({ snapshot }) => (0, import_line2.buildTokenChannelStatusSummary)(snapshot),
    ...
    buildAccountSnapshot: ({ account, runtime, probe }) => {
      ...
      const base = (0, import_line2.buildComputedAccountStatusSnapshot)({
        accountId: account.accountId,
        name: account.name,
        enabled: account.enabled,
        configured,
  ...
  gateway: {
    ...
    logoutAccount: async ({ accountId, cfg }) => {
      ...
      const accountCleanup = (0, import_line2.clearAccountEntryFields)({
...
var plugin = {
  ...
  configSchema: (0, import_line3.emptyPluginConfigSchema)(),
  register(api) {
